...
### 🤖 Умная Вытяжка Pro Max: Динамика, Таймер, Условия | Smart !!! Two
<details>
  ...
  [![Open your Home Assistant instance and show the blueprint import dialog with a specific blueprint url pre-filled.](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https://github.com/smirnowegor/HomeAssistant_blueprints/blob/main/blueprints/automation/smirnowegor/humidFanSmart.yaml)
...
### 🤖 Умная Вытяжка Pro Max: Динамика, Таймер, Условия | Smart !!!
<details>
  <summary><b>📖 Развернуть описание и установку</b></summary>
...
Все блупринты поддерживают **HACS** и стандартный импорт.

## 📥 Как установить

**Способ 1: HACS (Рекомендуемый)**
1. HACS > Integrations > Custom Repositories.
2. URL: `https://github.com/smirnowegor/HomeAssistant_blueprints`
3. Category: **Blueprint**.

**Способ 2: Кнопки ниже**
Просто нажмите на синюю кнопку "Import" под нужным блупринтом.
